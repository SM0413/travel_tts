...
switch (_that) {
case _UploadTextsModel() when $default != null:
return $default(_that.sourceController,_that.targetController,_that.localeController,_that.speakSpeedController,_that.pitchSpeedController,_that.tagController,_that.sourceFocus,_that.targetFocus,_that.localeFocus,_that.speakSpeedFocus,_that.pitchSpeedFocus,_that.tagFocus,_that.formKey,_that.sourceKey,_that.targetKey,_that.localeKey,_that.speakSpeedKey,_that.pitchSpeedKey,_that.tagKey,_that.sourceTransLang,_that.targetTransLang,_that.isFinished,_that.isShare);case _:
  return orElse();
...
class _UploadTextsModel implements UploadTextsModel {
  const _UploadTextsModel({required this.sourceController, required this.targetController, required this.localeController, required this.speakSpeedController, required this.pitchSpeedController, required this.tagController, required this.sourceFocus, required this.targetFocus, required this.localeFocus, required this.speakSpeedFocus, required this.pitchSpeedFocus, required this.tagFocus, required this.formKey, required this.sourceKey, required this.targetKey, required this.localeKey, required this.speakSpeedKey, required this.pitchSpeedKey, required this.tagKey, required this.sourceTransLang, required this.targetTransLang, this.isFinished = false, this.isShare = false});
